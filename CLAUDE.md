...
> Repo: **viralefy_core**
> Go DDD-ish, motor de domínio do Viralefy. Postgres via `pgx/v5`.
> Migrations em `/internal/infrastructure/migrations`. É o coração do produto —
> mudança aqui exige cuidado redobrado com testes, migration reversível e archive.
